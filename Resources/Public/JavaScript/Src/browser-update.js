...
/*global cookieNotice,jQuery,document,window*/
//jQuery(document).ready(function ($) {
    ...
    var $bu_ = new function () {
        ...
        this.get_browser = function (ua) {
            ...
            if (/windows.nt.5.1|windows.nt.5.2|windows.nt.6.0/i.test(ua)) r.available = {
                "c": 49.9,
                "f": 52.9
            };
